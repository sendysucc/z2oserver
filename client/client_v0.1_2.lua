...
local function dispatch_package()
	while true do
		...
		print('-0----------resType:',resType, 'name :',name)
		return args
	end
end
...
host = sproto.new( loadproto.getprotobin("./server/protocol/qznn_s2c.spt") ):host "package"
request = host:attach(sproto.new( loadproto.getprotobin("./server/protocol/qznn_c2s.spt")) )
